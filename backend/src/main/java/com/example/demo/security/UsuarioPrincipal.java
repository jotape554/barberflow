...
/**
 * Wrapper de Usuario para o Spring Security.
 * Carrega o barbeariaId junto — é a partir daqui que TODOS os services
 * descobrem de qual conta/barbearia o usuário autenticado faz parte.
 */
@Getter
