...
class StripeWebhookIntegrationTest {
    ...
    private Long registrarBarbearia(String email) throws Exception {
    ...
    private String eventoCheckoutCompleto(Long barbeariaId, String customerId, String subscriptionId) {
        return """
                {
                  "id": "evt_test",
                  "object": "event",
                  ...
                  "data": {
                    "object": {
                      ...
                      "customer": "%s",
                      "subscription": "%s",
                      "metadata": { "barbeariaId": "%d", "plano": "PROFISSIONAL" }
                    }
                  }
                }
                """.formatted(customerId, subscriptionId, barbeariaId);
    }

    @Test
    void eventoComAssinaturaValidaAtivaAAssinatura() throws Exception {
        Long barbeariaId = registrarBarbearia("webhook-valido@teste.com");
        String payload = eventoCheckoutCompleto(barbeariaId, "cus_valido", "sub_valido");
    ...
    void eventoComAssinaturaForjadaEhRejeitadoENaoAtivaNada() throws Exception {
        Long barbeariaId = registrarBarbearia("webhook-forjado@teste.com");
        String payload = eventoCheckoutCompleto(barbeariaId, "cus_forjado", "sub_forjado");
