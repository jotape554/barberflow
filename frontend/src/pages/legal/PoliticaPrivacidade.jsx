  ...
  return (
    <div className="doc-legal">
      ...
      <div className="doc-aviso">
        Este documento descreve, de forma simples e direta, quais dados o BarberPro coleta e
        como eles são usados. Não substitui aconselhamento jurídico profissional.
      </div>

      <p>
        O BarberPro é um sistema de gestão para barbearias. Esta política se aplica a dois
        tipos de dado: os dados da <strong>barbearia que contrata o BarberPro</strong> (dono,
        gerentes, profissionais) e os dados dos <strong>clientes finais dessa barbearia</strong>
        {' '}(as pessoas que agendam um corte).
      </p>

      <h2>1. Quais dados coletamos</h2>
      <p><strong>Da barbearia (quem assina o BarberPro):</strong></p>
      <ul>
      ...
      <p>
        Esses dados de clientes finais pertencem à barbearia que os cadastrou — o BarberPro atua
      ...
      <p>Usamos os seguintes serviços de terceiros para o BarberPro funcionar:</p>
      <ul>
        <li><strong>Stripe</strong> — processa o pagamento da assinatura. O BarberPro nunca vê nem armazena o número do cartão de crédito;</li>
        ...
        <li><strong>Railway</strong> — hospeda o banco de dados e os servidores do BarberPro.</li>
      </ul>
      <p>
      ...
      <p>
        Se você é um cliente final de uma barbearia que usa o BarberPro e quer exercer esses
      ...
      <p>
        Podemos atualizar esta política conforme o BarberPro evolui. Mudanças importantes serão
